...
public class Assert {
   ...
   */
  public static void assertTrue(boolean condition, int testcase, String message) {
//	  System.out.println("TESTCASE: "+testcase);System.out.print(condition);
    if (!condition) {

      failNotEquals(condition, Boolean.TRUE, testcase, message);
    }
 ...
 * @param testcase 
   */
  public static void assertTrue(boolean condition, int testcase ) {
    assertTrue(condition, testcase, null);
  }
   ...
   * @param message the assertion error message
   */
  public static void assertFalse(boolean condition, int testcase, String message) {
    if (condition) {
      failNotEquals(condition, Boolean.FALSE, testcase, message); // TESTNG-81
    }
  }
   ...
   * @param condition the condition to evaluate
   */
  public static void assertFalse(boolean condition, int testcase) {
    assertFalse(condition, testcase, null);
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(Object actual, Object expected, int testcase, String message) {
    if (expected != null && expected.getClass().isArray()) {
      assertArrayEquals(actual, expected, testcase, message);
      return;
    }
    assertEqualsImpl(actual, expected, testcase, message);
  }
...
//    equality of collections content.
  ...
  private static void assertEqualsImpl(Object actual, Object expected,int testcase, String message) {
    if ((expected == null) && (actual == null)) {
      return;
    }
    if (expected == null ^ actual == null) {
      failNotEquals(actual, expected, testcase, message);
    }
    if (expected.equals(actual) && actual.equals(expected)) {
      return;
    }
    fail(format(actual, expected, testcase, message, true));
  }

  private static void assertArrayEquals(Object actual, Object expected, int testcase, String message) {
    if (expected == actual) {
      return;
    }
    if (null == expected) {
    ...
    for (int i = 0; i < expectedLength; i++) {
      ...
      try {
        assertEquals(_actual, _expected, testcase);
   ...
   * @param expected the expected value
   */
  public static void assertEquals(float[] actual, float[] expected, int testcase) {
    assertEquals(actual, expected, testcase, "");
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(float[] actual, float[] expected, int testcase, String message) {
    if (checkRefEqualityAndLength(actual, expected, message)) return;

    for (int i = 0; i < expected.length; i++) {
      assertEquals(actual[i], expected[i], testcase,
              String.format(
                      ARRAY_MISMATCH_TEMPLATE,
                      i,
   ...
   */
  public static void assertEquals(float[] actual, float[] expected, float delta, int testcase) {
    assertEquals(actual, expected, delta,  testcase, "");
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(float[] actual, float[] expected, float delta, int testcase, String message) {
    if (checkRefEqualityAndLength(actual, expected, message)) {
      return;
    }

    for (int i = 0; i < expected.length; i++) {
      assertEquals(actual[i], expected[i], delta, testcase,
              String.format(
                      ARRAY_MISMATCH_TEMPLATE,
                      i,
                      Float.toString(expected[i]),
   ...
   * @param expected the expected value
   */
  public static void assertEquals(double[] actual, double[] expected, int testcase) {
    assertEquals(actual, expected, testcase, "");
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(double[] actual, double[] expected, int testcase, String message) {
    if (checkRefEqualityAndLength(actual, expected, message)) return;
   ...
   * @param delta the absolute tolerable difference between the actual and expected values
   */
  public static void assertEquals(double[] actual, double[] expected, int testcase, double delta) {
    assertEquals(actual, expected, delta, testcase, "");
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(double[] actual, double[] expected, double delta,int testcase, String message) {
    if (checkRefEqualityAndLength(actual, expected, message)) {
      return;
    }
   ...
   * @param expected the expected value
   */
  public static void assertEquals(Object actual, Object expected, int testcase) {
    assertEquals(actual, expected, testcase, null);
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(String actual, String expected, int testcase,  String message) {
    assertEquals((Object) actual, (Object) expected, testcase, message);
  }
   ...
   * @param expected the expected value
   */
  public static void assertEquals(String actual, String expected, int testcase) {
    assertEquals(actual, expected, testcase, null);
  }
   ...
   * @param delta the absolute tolerable difference between the actual and expected values
   */
  public static void assertEquals(double actual, double expected, double delta, int testcase) {
    assertEquals(actual, expected, delta, testcase, null);
  }
   ...
   */
  public static void assertNotNull(Object object, int testcase) {
    assertNotNull(object, testcase, null);
  }
   ...
   * @param message the assertion error message
   */
  public static void assertNotNull(Object object, int testcase, String message) {
    if (object == null) {
      String formatted = "";
      if (message != null) {
        formatted = message + " ";
    ...
    assertTrue(object != null, testcase, message);
  }
  ...
  private static void failNotEquals(Object actual,  Object expected,int testcase, String message) {
    fail(format(actual, expected, testcase, message, true));
  }

  static String format(Object actual, Object expected, int testcase, String message, boolean isAssertEquals) {
//   System.out.println(testcase );
//   System.out.println(isAssertEquals );
	  String formatted = "";
    if (null != message) {
      formatted = message + " ";
    }
   ...
   * @param expected the expected value
   */
  public static void assertEquals(Collection<?> actual, int testcase, Collection<?> expected) {
    assertEquals(actual, expected, testcase, null);
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(Collection<?> actual, Collection<?> expected, int testcase, String message) {
    if (actual == expected) {
      return;
    }
    ...
    while (actIt.hasNext() && expIt.hasNext()) {
      ...
      assertEqualsImpl(a, e, testcase, errorMessage);
    }
  }
   ...
   * @param expected the expected value
   */
  public static void assertEquals(Iterator<?> actual, Iterator<?> expected, int testcase) {
    assertEquals(actual, expected, testcase, null);
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(Iterator<?> actual, Iterator<?> expected, int testcase, String message) {
    if (actual == expected) {
      return;
    }
    if (actual == null || expected == null) {
   ...
   * @param expected the expected value
   */
  public static void assertEquals(Iterable<?> actual, Iterable<?> expected, int testcase) {
    assertEquals(actual, expected, testcase, null);
  }
   ...
   * @param message the assertion error message
   */
  public static void assertEquals(Iterable<?> actual, Iterable<?> expected, int testcase, String message) {
    if (actual == expected) {
      return;
    }
    ...
    assertEquals(actIt, expIt, testcase, message);
  }
  ...
  public static void assertEquals(Object[] actual, Object[] expected, int testcase, String message) {
    ...
    for(int i=0; i<expected.length; i++) {
      ...
      if ((a == null && e != null) || (a != null && e == null)) {
        failNotEquals(a, e, testcase, message);
      }
      //Compare by value for multi-dimensional array.
      if(e.getClass().isArray()) {
        assertEquals(a, e, testcase, errorMessage);
      } else {
        assertEqualsImpl(a, e, testcase, errorMessage);
      }
    }
  ...
  public static void assertEquals(Set<?> actual, Set<?> expected, int testcase) {
    assertEquals(actual, expected, testcase, null);
  }

  /** Assert set equals */
  public static void assertEquals(Set<?> actual, Set<?> expected, int testcase, String message) {
    if (actual == expected) {
      return;
    }
  ...
  public static void assertEqualsDeep(Set<?> actual, Set<?> expected, int testcase, String message) {
    if (actual == expected) {
      return;
    }
    ...
    while (expectedIterator.hasNext()) {
      ...
      if (expectedValue.getClass().isArray()) {
        assertArrayEquals(value, expectedValue, testcase, message);
      } else {
        assertEqualsImpl(value, expectedValue, testcase, message);
      }
    }
  }

  public static void assertEquals(Map<?, ?> actual, Map<?, ?> expected, int testcase) {
    assertEquals(actual, expected, testcase, null);
  }

  /** Asserts that two maps are equal. */
  public static void assertEquals(Map<?, ?> actual, Map<?, ?> expected, int testcase, String message) {
    if (actual == expected) {
      return;
    }
      ...
      String assertMessage =
          message != null
              ...
              : "Maps do not match for key:"
                  ...
                  + " expected:"
                  + expectedValue;
      assertEqualsImpl(value, expectedValue, testcase, assertMessage);
    }
  }

  public static void assertEqualsDeep(Map<?, ?> actual, Map<?, ?> expected, int testcase) {
    assertEqualsDeep(actual, expected, testcase, null);
  }

  public static void assertEqualsDeep(Map<?, ?> actual, Map<?, ?> expected, int testcase, String message) {
    if (actual == expected) {
      return;
    }
      ...
      String assertMessage =
          message != null
              ...
              : "Maps do not match for key:"
                  ...
                  + expectedValue;
      if (expectedValue.getClass().isArray()) {
        assertArrayEquals(value, expectedValue,  testcase, assertMessage);
      } else {
        assertEqualsImpl(value, expectedValue,testcase, assertMessage);
      }
    }
  ...
  public static void assertNotEquals(Object actual1, Object actual2, int testcase, String message) {
    boolean fail;
    try {
      Assert.assertEquals(actual1, actual2, testcase);
      fail = true;
    ...
    if (fail) {
      fail(format(actual1, actual2, testcase, message, false));
    }
  }

  public static void assertNotEquals(Object actual1, Object actual2, int testcase) {
    assertNotEquals(actual1, actual2,testcase, null);
  }

  static void assertNotEquals(String actual1, String actual2, int testcase, String message) {
    assertNotEquals((Object) actual1, (Object) actual2, testcase, message);
  }

  static void assertNotEquals(String actual1, String actual2, int testcase) {
    assertNotEquals(actual1, actual2, testcase, null);
  }
  ...
  public static void assertNotEquals(float actual1, float actual2, float delta, int testcase, String message) {
    boolean fail;
    try {
      Assert.assertEquals(actual1, actual2, delta, testcase, message);
      fail = true;
    } catch (AssertionError e) {
      fail = false;
    }
    ...
    if (fail) {
      Assert.fail(format(actual1, actual2, testcase, message, false));
    }
  }

  public static void assertNotEquals(float actual1, float actual2, float delta, int testcase) {
    assertNotEquals(actual1, actual2, delta, testcase, null);
  }

  public static void assertNotEquals(double actual1, double actual2, double delta, int testcase, String message) {
    boolean fail;
    try {
      Assert.assertEquals(actual1, actual2, delta, testcase, message);
      fail = true;
  ...
  public static void assertNotEquals(Set<?> actual, Set<?> expected,  int testcase) {
    assertNotEquals(actual, expected, testcase, null);
  }

  public static void assertNotEquals(Set<?> actual, Set<?> expected, int testcase, String message) {
    boolean fail;
    try {
      Assert.assertEquals(actual, expected, testcase, message);
      fail = true;
    } catch (AssertionError e) {
      fail = false;
    }
    ...
    if (fail) {
      Assert.fail(format(actual, expected, testcase, message, false));
    }
  }

  public static void assertNotEqualsDeep(Set<?> actual, Set<?> expected, int testcase) {
    assertNotEqualsDeep(actual, expected, testcase, null);
  }

  public static void assertNotEqualsDeep(Set<?> actual, Set<?> expected, int testcase, String message) {
    boolean fail;
    try {
      Assert.assertEqualsDeep(actual, expected, testcase, message);
      fail = true;
    } catch (AssertionError e) {
      fail = false;
    }
  ...
  public static void assertNotEquals(Map<?, ?> actual, Map<?, ?> expected, int testcase) {
    assertNotEquals(actual, expected,  testcase, null);
  }

  public static void assertNotEquals(Map<?, ?> actual, Map<?, ?> expected, int testcase, String message) {
    boolean fail;
    try {
      Assert.assertEquals(actual, expected, testcase, message);
      fail = true;
  ...
  public static void assertNotEqualsDeep(Map<?, ?> actual, Map<?, ?> expected, int testcase) {
    assertNotEqualsDeep(actual, expected, testcase, null);
  }

  public static void assertNotEqualsDeep(Map<?, ?> actual, Map<?, ?> expected, int testcase,  String message) {
    boolean fail;
    try {
      Assert.assertEqualsDeep(actual, expected, testcase, message);
      fail = true;
  ...
  public static void assertNotEquals(double actual1, double actual2,int testcase, double delta) {
    assertNotEquals(actual1, actual2, delta, testcase, null);
  }
